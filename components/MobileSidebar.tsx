  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-20 left-4 z-50 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-lg shadow-lg transition-colors"
      ...
      {isOpen && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          />
          <div className="absolute left-0 top-0 h-full w-80 bg-gradient-to-b from-dark-900 to-dark-950 shadow-2xl">
